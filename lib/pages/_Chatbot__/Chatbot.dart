...
//       String question = chatMessage.text;
//       if (question.isEmpty) {
//         print("The question text is empty.");
//         return; // تجنب إرسال طلب فارغ
//       }

//       List<Uint8List>? images;
//       if (chatMessage.medias?.isNotEmpty ?? false) {
//         String imagePath = chatMessage.medias!.first.url;
...
class _HomePageState extends State<Chatbot> {
  ...
  void _sendMessage(ChatMessage chatMessage) {
    ...
    try {
      ...
      print("Error: $e");
      // يمكنك تسجيل مزيد من التفاصيل حول الخطأ هنا إذا لزم الأمر
    }
  }
}
