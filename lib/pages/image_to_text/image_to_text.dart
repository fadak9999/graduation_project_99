...
//     // طلب السماحية إذا لم تكن ممنوحة
//     if (!status.isGranted) {
//       final result = await Permission.photos.request();
//       if (result.isDenied) {
//         _showPermissionDialog(
//             "يجب منح الإذن للوصول إلى الصور. الرجاء المحاولة مجددًا.");
//         return;
//       } else if (result.isPermanentlyDenied) {
//         _showPermissionDialog(
//             "تم منع الوصول إلى الصور. يرجى السماح بذلك من إعدادات التطبيق.");
//         return;
//       }
//     }

//     // السماحية مقبولة - اختر الصورة
//     final XFile? imageFile =
//         await _picker.pickImage(source: ImageSource.gallery);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        //  Text('استخراج النص من الصورة',style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
      //  centerTitle: true,
      //  elevation: 4,
      ),
      body: Padding(
